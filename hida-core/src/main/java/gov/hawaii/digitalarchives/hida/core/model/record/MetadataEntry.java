...
/**
 * The MetadataEntry class model.
 * <p>
 * This preserves its immutability.
 * <p>
 * Structure class for containing a K,V pair of metadata elements for
 * a record.
 *
 * @author Dongie Agnir
...
public class MetadataEntry implements Serializable {
     ...
     */
    private static final long serialVersionUID = 4059901982907610282L;

    /** The Unique Primary Identifier for a MetadataEntry. */
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    @Column(name = "METADATA_ENTRY_ID")
    ...
    /**
     * The name of this particular metadata entry.
     */
    @Column(name = "NAME")
    private String name;

    /**
     * The value of this this particular metadata entry.
     */
    @Column(name = "VALUE")
    private String value;

    /**
     * The ID of the {@link FileObject} that this piece of data was
     * extracted from.
     */
    @Column(name = "OBJECT_EXTRACTED_FROM")
    private String objectExtractedFrom;
    ...
    /**
     * Used to create a MetadataEntry object.
     * 
     * @param name  The name of this particular metadata entry.
     * @param value  The value of this this particular metadata entry.
     * @param objectExtractedFrom  The ID of the {@link FileObject} that 
     *                             this piece of data was extracted from.
     */
    public MetadataEntry(final String name, final String value,
                                final String objectExtractedFrom) {
        this.name = name; 
        this.value = value;
        this.objectExtractedFrom = objectExtractedFrom;
        
        Assert.notNull(name, "name cannot be null");
        Assert.hasLength(name, "name cannot be empty");
        Assert.notNull(value, "value cannot be null");
        Assert.hasLength(value, "value cannot be empty");
        Assert.notNull(objectExtractedFrom, "objectExtractedFrom cannot be null");
    }
    ...
    public static final EntityManager entityManager() {
        ...
        EntityManager em = new MetadataEntry().entityManager;
        if (em == null)  {
    ...
    private static final Logger staticMethodLogger() {
        Logger log = new MetadataEntry().log;
        if (log == null) {
    ...
    /**
     * @return The name of this particular metadata entry.
     */
    ...
    /**
     * @return The value of this this particular metadata entry.
     */
    ...
    /**
     * @return The ID of the {@link FileObject} that this piece of data was
     * extracted from.
     */
    public String getObjectExtractedFrom() {
        log.debug("Entering getObjectExtractedFrom()");
        log.debug("Exiting getObjectExtractedFrom(): {}", objectExtractedFrom);
        return objectExtractedFrom;
    }
    ...
    /**
     * @return The ID of this MetadataEntry.
     */
    ...
    /**
     * Gets the version of this MetadataEntry.
     * 
     * @return  The version of this MetadataEntry.
     */
    ...
    /**
     * Sets the version of this MetadataEntry.
     * 
     * @param version  The version of this MetadataEntry.
     */
    ...
    /**
     * Gets the amount of MetadataEntry objects that are currently 
     * in the database.
     * 
     * @return The amount of MetadataEntry objects that are 
     *         currently in the database.
     */
    public static long countMetadataEntries() {
        staticMethodLogger().debug("Entering countMetadataEntries()");
        long count = entityManager().createQuery("SELECT COUNT(o) FROM MetadataEntry o",
                Long.class).getSingleResult();
        staticMethodLogger().debug("Exiting countMetadataEntries(): {}", count);
        return count;
    }
    ...
    /**
     * Gets all of the MetadataEntry objects from the database 
     * and puts them in a collection. 
     * 
     * @return The collection of MetadataEntries that are 
     *         in the database.
     */
    public static List<MetadataEntry> findAllMetadataEntries() {
        staticMethodLogger().debug("Entering findAllMetadataEntries()");
        List<MetadataEntry> metadataEntries = entityManager()
                .createQuery("SELECT o FROM MetadataEntry o", MetadataEntry.class)
                .getResultList();
        staticMethodLogger().debug("Exiting findAllMetadataEntries(): {}", metadataEntries);
    ...
    /**
     * Queries for a MetadataEntry based on its primaryId.
     * 
     * @param primaryId  The long primaryId associated with the 
     *                   MetadataEntry that you want to search the database 
     *                   for.
     * @return  The associated MetadataEntry matching the primaryId you were
     *          searching for, or null if not found.
     */
    public static MetadataEntry findMetadataEntry(Long primaryId) {
        staticMethodLogger().debug("Entering findMetadataEntry(primaryId = {})", primaryId);
        if (primaryId == null) {
            staticMethodLogger().debug("Exiting findMetadataEntry(): null)");
            return null;
        }
        MetadataEntry metadataEntry = entityManager().find(MetadataEntry.class, primaryId);
        staticMethodLogger().debug("Exiting findMetadataEntry(): {})", metadataEntry);
    ...
    /**
     * Gets a certain subset of MetadataEntries based 
     ...
     * @return             The collection of MetadataEntries based 
     *                     on the range desired. 
     */
    public static List<MetadataEntry> findMetadataEntryEntries(int firstResult, int maxResults) {
        staticMethodLogger().debug("Entering findMetadataEntryEntries(firstResult = {}, " +
                "maxResults = {})",
        ...
        staticMethodLogger().debug("Exiting findMetadataEntryEntries(): {}", metadataEntries);
        return metadataEntries;
    }
    ...
    public void remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            MetadataEntry attached = MetadataEntry.findMetadataEntry(this.primaryId);
     ...
     * 
     * @return The merged MetadataEntry.
     */
    @Transactional
    public MetadataEntry merge() {
        log.debug("Entering merge()");
        if (this.entityManager == null) 
            this.entityManager = entityManager();
        MetadataEntry merged = this.entityManager.merge(this);
        this.entityManager.flush();
